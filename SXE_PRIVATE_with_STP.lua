...
do
    ...
    local function doVelocityTP()
        ...
        if petPos.Y > 8.9 and petPos.Y <= FLOOR2_MAX_Y then
            ...
            local _r2Speed = (_r2Len < 100) and 200 or math.clamp(tonumber(_G.TPVelocity) or _tpSpd, 200, 500)
            ...
            task.wait(tonumber(_G.LandingDelay) or (Config and Config.TpSettings and Config.TpSettings.CloneDelayVal) or 0.4)
