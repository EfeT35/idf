...
task.spawn(function()
    ...
    task.spawn(function()
        ...
        local FG_Theme = {
            Window   = rgb(22, 18, 28),
            WindowB  = rgb(28, 23, 35),
            Sidebar  = rgb(18, 15, 24),
            TopBar   = rgb(26, 21, 33),
            Card     = rgb(34, 28, 44),
            CardAlt  = rgb(44, 36, 56),
            CardAlt2 = rgb(56, 46, 70),
            Stroke   = rgb(75, 50, 70),
            StrokeS  = rgb(100, 68, 90),
            Text     = rgb(255, 255, 255),
            SubText  = rgb(195, 170, 210),
            Faint    = rgb(140, 115, 155),
            Accent   = rgb(232, 111, 177),
            Accent2  = rgb(195, 65, 140),
            AccentSoft = rgb(70, 38, 62),
            Green    = rgb(100, 220, 140),
            Green2   = rgb(75, 200, 115),
            Track    = rgb(62, 46, 62),
            Shadow   = rgb(0, 0, 0),
        }
        ...
        function Section:AddDivider()
            ...
            fg_new("Frame", {
                ...
                BackgroundColor3 = Color3.fromRGB(80, 45, 65),
