...
task.spawn(function()
    ...
    task.spawn(function()
        ...
        local FG_Theme = {
            Window   = rgb(15, 13, 18),
            WindowB  = rgb(20, 18, 24),
            Sidebar  = rgb(25, 20, 30),
            TopBar   = rgb(22, 18, 27),
            Card     = rgb(28, 24, 33),
            CardAlt  = rgb(35, 29, 42),
            CardAlt2 = rgb(48, 38, 55),
            Stroke   = rgb(65, 42, 60),
            StrokeS  = rgb(85, 58, 75),
            Text     = rgb(255, 255, 255),
            SubText  = rgb(200, 175, 210),
            Faint    = rgb(145, 120, 155),
            Accent   = rgb(232, 111, 177),
            Accent2  = rgb(200, 70, 145),
            AccentSoft = rgb(60, 35, 55),
